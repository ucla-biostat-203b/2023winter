...
- [Code](https://github.com/ucla-biostat-203b/2022winter/tree/main/slides/11-shiny/census-app) for the Shiny app `census-app`.
...
- [Code](https://github.com/ucla-biostat-203b/2022winter/tree/main/slides/11-shiny/stockVis) for the Shiny app `stockVis`.
