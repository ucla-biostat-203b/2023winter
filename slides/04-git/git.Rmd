...
- Initialize a project.
    ...
    - Create a repository, e.g., `biostat-203b-2022-winter` on GitHub.
    
    - Clone the repository to your local machine:
    ```{bash, eval=FALSE}
    git clone git@github.com:[USERNAME]/biostat-203b-2022-winter.git
    ```
...
- Create a private repository `biostat-203b-2022-winter`. Add `Hua-Zhou` and `maschepps` as your collaborators with write permission.
