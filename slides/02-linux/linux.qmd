...
- To practice the Linux commands, we can either use Binder (in cloud) or Docker on your own computer (will be covered in this Thursday's lab).

- In this lecture, most code chunks  contains `bash` commands instead of R code. 
...
- _Private key_. Put on your own computer. Consider this as the actual key in your pocket; **never give private key to others**. For fun: 
